...
//     let shoppingListCheckbox = null;
//     if (provision.units === 0) {
//       const checkboxContainer = document.createElement("div");
//       checkboxContainer.classList.add("checkbox-container");

//       shoppingListCheckbox = document.createElement("input");
...
//     if (shoppingListCheckbox) {
//       provisionItem.appendChild(shoppingListCheckbox.parentElement);
//     }
...
//   // After updating units, reload provisions to update the UI
//   fetch(`${baseApiUrl}/${provisionId}`)
//     .then((response) => response.json())
//     .then((provisionData) => {
//       // Update the units in the provision data
...
// // Modify the confirmRemove function
// function confirmRemove(provisionId) {
